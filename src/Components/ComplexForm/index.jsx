    ...
    return (
        <LoginFormWrapper>
            <form className={classes.root}>
                ...
                <TextField type={'text'} id="outlined-basic" label="Company" variant="outlined"
                           placeholder={'Acme Inc.'} required/><br/>
                <FormControl required>
                    <InputLabel id="company-select-required-label">Company size</InputLabel>
                    <Select labelId="company-select-required-label" id="company-select-required">
                ...
                <FormControl required>
                    <InputLabel id="country-list-select-required-label">Country</InputLabel>
                    <Select labelId="country-list-select-required-label" id="country-list-select-required">
                ...
                <FormControl required>
                    <InputLabel id="help-select-required-label">InputLab How can our sales team help you?</InputLabel>
                    <Select labelId="help-select-required-label" id="help-select-required">
                ...
                <TextareaAutosize aria-label="minimum height" rowsMin={3}
                                  placeholder="What challenges are you looking to overcome with Slack?"/><br/>
